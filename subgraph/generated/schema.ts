...
export class Inbox extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save Inbox entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save Inbox entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("Inbox", id.toString(), this);
    }
  }

  static load(id: string): Inbox | null {
    return changetype<Inbox | null>(store.get("Inbox", id));
  }
...
export class FeedPub extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));

    this.set("feed", Value.fromString(""));
    this.set("author", Value.fromString(""));
    this.set("pub", Value.fromString(""));
    this.set("createdAt", Value.fromBigInt(BigInt.zero()));
  }

  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save FeedPub entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save FeedPub entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("FeedPub", id.toString(), this);
    }
  }

  static load(id: string): FeedPub | null {
    return changetype<FeedPub | null>(store.get("FeedPub", id));
  }
  ...
  get pub(): string {
    let value = this.get("pub");
    return value!.toString();
  }

  set pub(value: string) {
    this.set("pub", Value.fromString(value));
  }
...
export class User extends Entity {
  constructor(id: string) {
    ...
    this.set("inbox", Value.fromString(""));
    this.set("profile", Value.fromString(""));
  }
  ...
  set inbox(value: string) {
    this.set("inbox", Value.fromString(value));
  }
